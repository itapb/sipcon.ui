namespace Sipcon.WebApp.Client.Services
{
    ...
    public interface IReportingService
    {
        ...
        public Task<ApiResponse<List<ExpandoObject>>> GetReports(int IdReporting, int IdSupplier, int IdUser, int RowFrom = 0, string Filter = "", string DateFrom = "", string DateTo = "", int? IdDealer = null, int? EstatusId = null);
