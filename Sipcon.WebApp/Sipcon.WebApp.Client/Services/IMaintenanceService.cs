namespace Sipcon.WebApp.Client.Services
{
    ...
    public interface IMaintenanceService
    {
        ...
        public Task<ApiResponse<List<Maintenance>>> GetMaintenances(int IdUser, int RowFrom = 0, string Filter = "", int? IdDealer = null);
        ...
        public Task<ApiResponse<List<byte>>> ExportMaintenances(int IdUser, string Filter = "", int? IdDealer = null);
