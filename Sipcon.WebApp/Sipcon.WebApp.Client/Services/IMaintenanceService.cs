namespace Sipcon.WebApp.Client.Services
{
    ...
    public interface IMaintenanceService
    {
        ...
        public Task<ApiResponse<List<ActionResult>>> CreateMaintenance(Maintenance Maintenance, int IdUser);
        public Task<ApiResponse<List<ActionResult>>> UpdateMaintenance(Maintenance Maintenance, int IdUser);
        public Task<ApiResponse<List<ActionResult>>> ActionsMaintenance(List<PostAction> PostActions, int IdUser);
