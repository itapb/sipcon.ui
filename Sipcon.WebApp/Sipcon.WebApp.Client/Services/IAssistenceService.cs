namespace Sipcon.WebApp.Client.Services
{
    ...
    public interface IAssistenceService
    {
        ...
        public Task<ApiResponse<List<ActionResult>>> CreateAssistence(Assistence Assistence, int IdUser);
        public Task<ApiResponse<List<ActionResult>>> UpdateAssistence(Assistence Assistence, int IdUser);
        public Task<ApiResponse<List<ActionResult>>> ActionsAssistence(List<PostAction> PostActions, int IdUser);
