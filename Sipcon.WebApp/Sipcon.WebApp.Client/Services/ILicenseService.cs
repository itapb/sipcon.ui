namespace Sipcon.WebApp.Client.Services
{
    ...
    public interface ILicenseService
    {
        ...
        public Task<ApiResponse<ActionResult>> CreateLicense(Models.License License, int IdUser);
        public Task<ApiResponse<ActionResult>> UpdateLicense(Models.License License, int IdUser);
        public Task<ApiResponse<ActionResult>> ActionsLicense(List<PostAction> PostActions, int IdUser);
        ...
        public Task<ApiResponse<ActionResult>> CreateLicenseDetail(LicenseDetail Detail, int IdUser);
