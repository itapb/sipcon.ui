namespace Sipcon.WebApp.Client.Services
{
    ...
    public interface ILaborTimeService
    {
        ...
        public Task<ApiResponse<List<ActionResult>>> CreateLaborTime(LaborTime LaborTime, int IdUser);
        public Task<ApiResponse<List<ActionResult>>> UpdateLaborTime(LaborTime LaborTime, int IdUser);
        public Task<ApiResponse<List<ActionResult>>> DeleteLaborTimes(List<PostAction> PostActions, int IdUser);
