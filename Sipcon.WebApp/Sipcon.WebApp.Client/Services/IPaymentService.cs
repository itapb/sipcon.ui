namespace Sipcon.WebApp.Client.Services
{
    ...
    public interface IPaymentService
    {
        ...
        public Task<ApiResponse<List<Receivable>>> GetAccountReceivables(int IdUser, int Idsupplier, int? IdDealer, string TypeCode, string ConceptCode, int RowFrom = 0, string Filter = "", string DateFrom = "", string DateTo = "", int? EstatusId = null, string DatePay = "",bool? Migration = false);
