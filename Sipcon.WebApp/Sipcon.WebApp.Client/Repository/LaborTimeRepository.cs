namespace Sipcon.WebApp.Client.Repository
{
    ...
    public class LaborTimeRepository(HttpClient http) : ILaborTimeService
    {
        ...
        public async Task<ApiResponse<ActionResult>> CreateLaborTime(LaborTime LaborTime, int IdUser)
        {
        ...
        public async Task<ApiResponse<ActionResult>> UpdateLaborTime(LaborTime LaborTime, int IdUser)
        {
            ApiResponse<ActionResult>? result;
            List<LaborTime> laborTimes  = ([]);
            try
