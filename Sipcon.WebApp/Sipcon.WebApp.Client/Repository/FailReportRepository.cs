namespace Sipcon.WebApp.Client.Repository
{
    ...
    public class FailReportRepository(HttpClient http) : IFailReportService
    {
        ...
        public async Task<ApiResponse<List<FailReport>>> GetFailReports(int IdSupplier, int IdUser, int RowFrom = 0, string Filter = "", int? IdDealer = null, string DateFrom = "", string DateTo = "", int? EstatusId = null)
        {
        ...
        public async Task<ApiResponse<ActionResult>> UpdateFailReport(FailReport FailReport, int IdUser)
        {
            ApiResponse<ActionResult>? result;
        ...
        public async Task<ApiResponse<List<byte>>> ExportFailReports(int IdSupplier, int IdUser, string Filter = "", int? IdDealer = null, string DateFrom = "", string DateTo = "", int? EstatusId = null)
        {
        ...
        public async Task<ApiResponse<ActionResult>> CreateFailReportDetail(FailReportDetail Detail, int IdUser)
        {
            ApiResponse<ActionResult>? result;
        ...
        public async Task<ApiResponse<ActionResult>> UpdateFailReportDetail(FailReportDetail Detail, int IdUser)
        {
            ApiResponse<ActionResult>? result;
            try
            {
